			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('/add-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Categories</span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{url('/add-product')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Products</span></a></li>
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{url('/all-slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet">All Sliders </span></a></li>
								<li><a class="submenu" href="{{url('/add-slider')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Slider</span></a></li>
								
							</ul>	
						</li>
						
						<li><a href="{{url('/manage-order')}}"><i class="icon-list-alt"></i><span class="hidden-tablet">Manage Orders</span></a></li>
						<li><a href="typography.html"><i class="icon-font"></i><span class="hidden-tablet"> Shop Details</span></a></li>
						<li><a href="gallery.html"><i class="icon-picture"></i><span class="hidden-tablet"> Delivery Personnel</span></a></li>
