			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="{{url('/update-category', $categoryInfo->categoryId)}}" method="post">
						{{csrf_field()}}
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" name="categoryDescription"  rows="5" required=""> {{$categoryInfo->categoryDescription}} </textarea>
							  </div>
							</div>
							<!--<div class="control-group hidden-phone">
