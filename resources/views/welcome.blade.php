                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                ?>
                                @if($customerId!==NULL && $shipId == NULL)
                            ...
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        ...
                                        ?>
                                        @if($customerId!==NULL)
                                            <li><a href="{{url('/checkout')}}"><i class=""></i> Checkout</a></li>
                                        @else
                                             <li><a href="{{url('/login-check')}}"><i class=""></i> Checkout</a></li>
                                         @endif     
                        ...
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{url('/product-by-category/'.$allCategory->categoryId)}}">{{$allCategory->categoryName}}</a></h4>
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <?php $allBrands= DB::table('brands')
                              ...
                              foreach ($allBrands as $allBrand){?>
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="{{url('/product-by-brand/'.$allBrand->brandId)}}"> <span class="pull-right"></span>{{$allBrand->brandName}}</a></li>
